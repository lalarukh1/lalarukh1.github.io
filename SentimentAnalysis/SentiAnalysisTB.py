...
# preprocessing data for TextBlob
...
# testing preprocessing method - replace 2019 with other years when running script
for x in data2019['text']:
    print(x)
    print(clean_tweets(x))


with open('C:/Users/lalar/Desktop/tweets-2019/posTextblob.csv', mode='w', encoding="utf-8") as pos_file, open('C:/Users/lalar/Desktop/tweets-2019/negTextblob.csv', mode='w', encoding="utf-8") as neg_file:
    fieldnames = ['text']
    ...
    for x in data2019['text']:
        if pd.isnull(data2019['text'][i]):
            ...
            blob = TextBlob(clean_tweets(data2019['text'][i]))
            sentiment = blob.sentiment
            polarity = sentiment.polarity
            sentiment_scores.append(polarity)

            if polarity < 0:
                writer2.writerow({'text': (blob)})
            elif polarity > 0:
                writer1.writerow({'text': (blob)})
            else:
                print('neutral')
                print(i)
...
# 
with open('C:/Users/lalar/Desktop/tweets-2019/posTextblob.csv', encoding="utf-8") as pos_file:
    posjsonfile = open('C:/Users/lalar/AppData/Roaming/nltk_data/corpora/twitter_samples/tweets-2019/posTextblob.json', 'w')
    fieldnames = ['text']
    ...
    for row in reader:
        ...
        posjsonfile.write('\n')
#
with open('C:/Users/lalar/Desktop/tweets-2019/negTextblob.csv', encoding="utf-8") as neg_file:
    negjsonfile = open('C:/Users/lalar/AppData/Roaming/nltk_data/corpora/twitter_samples/tweets-2019/negTextblob.json', 'w')
    fieldnames = ['text']
...
positive_tweet_tokens = twitter_samples.tokenized('allPositiveTweets.json')
negative_tweet_tokens = twitter_samples.tokenized('allNegativeTweets.json')
...
train_data = dataset[:75906]
test_data = dataset[75906:]
...
# # Checking individual tweets

custom_tweet = "I am fucked for GCSE's"
